        ...
        <div className="container mx-auto px-1 lg:px-8">
          <div className="text-center max-w-[100%] mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative aspect-video  overflow-hidden border border-primary-foreground/10 max-w-4xl mx-auto"
            >
              <iframe
